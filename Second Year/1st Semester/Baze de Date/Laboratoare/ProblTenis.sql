...
insert into Arene(aid)values(1),(2)
insert into Jucatori(nume, puncte, valoare)values('Simona Halep',6100,12),('Serena Williams',5750,10),('Angelique Kerber',5500,11),('Caroline Wozniacki',5000,10),('Karolina Pliskova',4900,9),('Naomi Osaka',4850,9),('Jelena Ostapenko',4500,8)
insert into Turnee(locatie,start_ev,end_ev)values('Australia','2019-01-07','2019-01-12'),('Franta','2019-05-26','2019-06-08'),('Marea Britanie','2019-07-01','2019-07-13')

insert into Partide(aid,tid,data_ev)values(1,1,'2019-01-07 20:30:00'),(1,1,'2019-01-08 20:00:00'),(2,1,'2019-01-10 15:30:30'),(1,2,'2019-05-26 20:00:00'),(2,3,'2019-07-01 20:00:00')

insert into Games(pid,jid1,jid2,puncte1,puncte2,valoare1,valoare2,jidc)values(1,1,2,100,20,1,0,1),(2,3,4,150,50,1,0,3),(3,1,3,200,100,2,1,1)
