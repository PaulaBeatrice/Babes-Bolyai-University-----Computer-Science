...
insert into Librarii(nume,adresa) values('Alexandria','Falticeni'),('Humanitas','Suceava'),('Carturesti','Suceava')

insert into Domenii(descriere) values ('literatura'),('stiintific')

insert into Carti(titlu, data_buy, lid) values('Povestea Faridei','2018-06-12',1),('Alchimistul','2018-10-10',2),('Biblia pierduta','2018-11-29',3),('Padurea norvegiana','2018-03-10',1),('Portretul lui Dorian Gray','2017-12-10',2),('Zuleiha deschide ochii','2018-11-29',3),('M-am hotarat sa devin prost','2018-11-29',1)
