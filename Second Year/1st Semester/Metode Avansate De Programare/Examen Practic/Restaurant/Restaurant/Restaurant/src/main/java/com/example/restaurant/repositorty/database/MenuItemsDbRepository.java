...
public class MenuItemsDbRepository implements Repository<Integer, MenuItem> {
    ...
    private MenuItem getMenuItemFromResultSet(ResultSet resultSet) throws SQLException, SQLException {
    ...
    @Override
    public MenuItem find(Integer id) throws IllegalArgumentException {
        if(username == null) {
