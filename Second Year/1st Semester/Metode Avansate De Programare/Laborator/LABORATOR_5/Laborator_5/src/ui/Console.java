...
public class Console {
    ...
    void addFriendship() {
        ...
        try {
            ...
            try {
                ...
                System.out.println("The id can not contain letters or symbols!");
            }
            network.addFriendship(new Friendship(id1, id2, LocalDateTime.now()));
        } catch (ValidationException e) {
            System.out.println("The friendship is invalid!");
        } catch (IllegalArgumentException e) {
            System.out.println("Invalid arguments!");
        }
    }
    ...
    void updateUser() {
        printUser();
        Scanner scan = new Scanner(System.in);
        System.out.println("Id User you want to update");
        String val = scan.nextLine();
        Long id1 = Long.parseLong(val);
        System.out.println("First Name: ");
        String firstName = scan.nextLine();
    ...
    void updateFriendship() {
        printFriendship();
        Scanner scan = new Scanner(System.in);
        System.out.println("Id Friendship you want to update");
        String val = scan.nextLine();
        Long id = Long.parseLong(val);
        System.out.println("Id-ul primului user: ");
        ...
        try {
            ...
            long id2 = 0L;
            try {
                id1 = Long.parseLong(val1);
                id2 = Long.parseLong(val2);
            } catch (IllegalArgumentException e) {
                System.out.println("The id can not contain letters or symbols!");
            }
            Friendship new_friendship = new Friendship(id1,id2,LocalDateTime.now());
            new_friendship.setId(id);
            network.updateFriendship(new_friendship);
        } catch (ValidationException e) {
            System.out.println("The friendship is invalid!");
        } catch (IllegalArgumentException e) {
            System.out.println("Invalid arguments!");
