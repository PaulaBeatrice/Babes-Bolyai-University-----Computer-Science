...
public class FriendRequestController implements Observer<FriendRequestEvent>
{
    ...
    public void initialize()
    {
       ...
       // final String password= ApplicationContext.getPROPERTIES().getProperty("database.socialnetwork.password");
        ...
        this.friendRequestService = new FriendshipRequestService(friendRequestRepository, friendshipRepository,userRepository, new FriendRequestValidator());
