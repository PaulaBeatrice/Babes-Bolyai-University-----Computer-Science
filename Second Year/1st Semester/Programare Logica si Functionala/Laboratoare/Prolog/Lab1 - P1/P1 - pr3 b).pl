...
%
%   descompunereLista(L: lista, P: lista, I: lista, nrP: intreg, nrI:
%   intreg)
%   L: lista din care vom prelua elementele si le vom plasa in celelalte
%   doua (P si I)
%   P: lista ce va contine elementele pare din lista L
%   I: lista ce va contine elementele impare din lista L
%   nrP: nr elementelor pare din lista L
%   nrI: nr elementelor impare din lista L
%
%   descompunerePareImpare(L: lista, PI: lista de liste, nrP: intreg,
%   nrI: intreg
%   L: lista din care vom extrage elementele si le vom plasa in lista PI
%   PI: lista ce va contine alte doua liste; prima va contine elementele
%   pare din L, iar a doua va contine elementele impare din L
%   nrP: nr elementelor pare din L
%   nrI: nr elementelor impare din L
