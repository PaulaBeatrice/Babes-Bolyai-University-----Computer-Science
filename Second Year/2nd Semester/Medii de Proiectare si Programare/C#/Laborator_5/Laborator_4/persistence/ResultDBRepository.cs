     ...
     public class ResultDBRepository:ResultRepository
    {
        ...
        public void Save(Result entity)
        {
            ...
            using (var command = conn.CreateCommand())
            {
                ...
                // Console.WriteLine("Adaugam in Repo + " + entity.Participant.Points + " pct " + entity.Points);
                // int new_points = entity.Participant.Points + entity.Points;
                Console.WriteLine("Adaugam in Repo + " + this.participantRepository.FindOne(entity.Participant.Id).Points + " pct " + entity.Points);
                int new_points = this.participantRepository.FindOne(entity.Participant.Id).Points + entity.Points;
                ...
                Console.WriteLine("Repo) New Parts " + new_participant.Points);
