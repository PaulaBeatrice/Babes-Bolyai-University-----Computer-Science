...
class BookService:
    ...
    def generate_book(self, number):
        for i in range(number):
            ...
            carte = Book(id, titlu, descriere, autor)
    ...
    def update_book(self, id, titlu, descriere, autor):
        """
...
def test_add_books():
    ...
    book = test_srv.add_book('1', 'ABC', 'abcdef', 'Ana')
...
def test_get_all_books():
    ...
    test_srv.update_book('2', 'ABC', 'sfdfsef', 'Dana')
    crt_books = test_srv.get_all_books()
    assert (len(crt_books) == 1)
...
def test_update_book():
    ...
    updated_book = test_srv.update_book('2', 'CARTE', 'fer', 'weri')
    ...
    try:
        test_srv.update_book('INVALID ID', 'CARTEEE', 'wfsv', 'fwes')
        assert False
    except BookNotFoundException:
        assert True
