...
def test_equal_books():
    b1 = Book('1', 'ABC', 'abcdef', 'Ana')
    b2 = Book('1', 'ABC', 'abcdef', 'Ana')
    assert(b1 == b2)

    b3 = Book('2', 'ABC', 'abcdef', 'Ana')
    assert (b1 != b3)
...
def test_create_client():
    c = Client('1', 'Bianca', '15290648945773')
    assert(c.getId() == '1')
...
def test_equal_clients():
    c1 = Client('1', 'Andrei', '15292888940073')
    c2 = Client('1', 'Andrei', '15292888940073')
    assert(c1 == c2)

    c3 = Client('2', 'Andreea', '15292888940073')
    assert (c1 != c3)
