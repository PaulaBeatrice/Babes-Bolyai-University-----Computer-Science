...
def setup_test_repo():
    ...
    c3 = Client('3', 'Cezar', '1414783002658')
    c4 = Client('4', 'Diana', '1479581489658')
    c5 = Client('5', 'Elena', '1449632502658')
    c6 = Client('6', 'Flavia', '1473333002658')
    c7 = Client('7', 'George', '4789552002658')
    c8 = Client('8', 'Ilinca', '7889983002658')
    c9 = Client('9', 'Marina', '1479478502658')
    c10 = Client('10', 'Paula', '1479587777658')
...
def test_repo_size():
    test_repo = InMemoryRepository_list()
    test_repo.clients(Client('1', 'Alexa', '1479583002658'))
    assert (test_repo.size() == 1)
...
class ClientRepoFile:
    ...
    def __load_from_file(self):
        ...
        lines = f.readlines()
        for line in lines:
            client_id, client_nume, client_cnp = [word.strip() for word in line.split(';')]
            a = Client(client_id, client_nume, client_cnp)
            clients.append(a)
        f.close()
        return clients
...
def test_clients_file():
    ...
    test_repo.clients(Client('550', 'wve', '3669852011559'))

    assert (test_repo.size() == 1)

    try:
        test_repo.clients(Client('550', 'asdv', '0223354789978'))
        assert False
    except DuplicateIDException:
        assert True

    test_repo.clients(Client('74', 'fh', '1478741025369'))
    test_repo.clients(Client('574150', 'wve', '9630145285202'))
    test_repo.clients(Client('662', 'wve', '7778852013524'))
    ...
    new_cl = Client('574150', 'frgb', '0147852369555')
    new_cl2 = Client('662', 'sdfv', '0045896325111')
