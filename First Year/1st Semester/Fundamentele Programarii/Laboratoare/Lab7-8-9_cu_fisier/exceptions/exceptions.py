...
class BookAlreadyRent(RepositoryException):
    def __init__(self):
        RepositoryException.__init__(self, "Aceasta carte nu este disponibila in acest moment. ")
...
class CorruptedFileException(LibraryException):
    def __init__(self):
        LibraryException.__init__(self, "Nu se poate deschide fisierul")
