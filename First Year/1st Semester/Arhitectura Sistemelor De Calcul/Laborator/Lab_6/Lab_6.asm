...
;Sa se determine suma cifrelor numarului multiplilor de 8 din sirul octetilor inferiori ai
; cuvintelor superioare ai dublucuvintelor superioare din elementele sirului de quadworduri.


;Solutie: Parcurgand sirul de quadworduri vom obtine intai numarul multiplilor de 8 din sirul
; octetilor inferiori ai cuvintelor superioare ai dublucuvintelor superioare din elementele sirului. 
;Apoi vom obtine cifrele acestui numar prin impartiri succesive la 10 si vom calcula suma lor.
