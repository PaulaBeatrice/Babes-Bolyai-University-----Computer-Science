...
class UndoAdauga : public ActiuneUndo {
	...
	Repo& repo;
public:
	UndoAdauga(Repo& repo,const Oferta& m) :repo{ repo }, ofAdaugat{ m } {}
...
class UndoSterge : public ActiuneUndo {
	...
	Repo& repo;
public:
	UndoSterge(Repo& repo, Oferta& ofSters) :repo{ repo }, ofSters{ ofSters } {}
	void doUndo() override {
		repo.store(ofSters);
	}
};
...
class UndoModify : public ActiuneUndo {
	...
	Repo& repo;
public:
	UndoModify(Repo& repo, Oferta& oldOF, Oferta& newOF) :repo{ repo }, oldOF{ oldOF }, newOF{ newOF } {}
	void doUndo() override {
